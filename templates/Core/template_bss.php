...
<body style="background:#1681F9 url('/i/bss/wrap_bgr_bss.png') no-repeat 50% 90px;">
...
<div id="wrap">
	...
	<div id="header">
		...
		<img src="/i/bss/bss_slogan.png" style="padding:45px 0 0 30px;"/>
<?php 
...
?>
		<table cellspacing="0" cellpadding="0" class="homeNav">
			<tr>
				...
				<td><a href="/<?=LNG_CURRENT==LNG_BG ? 'en/bss/presentation/' : 'bg/bss/presentation/'?>" style="background: url('/i/<?=LNG_CURRENT==LNG_BG ? 'en' : 'bg';?>_btn.png') no-repeat 50% 0; display:inline-block; width:34px; height:34px;"></a></td>
			</tr>
		</table>
		<div class="topNav">
		<?php 
...
EOD;
		...
		<table cellpadding="0" cellspacing="0" border="0" class="menu bss">
			<tr>
...
<?php 
	echo <<<EOD
		<td colspan="3"><img src="/i/bss/header_inner_bss.png" /></td>
		</tr><tr>
EOD;
