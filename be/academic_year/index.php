...
if($__mvc) {
	...
	$filter_session_name="filter_academic_year";
}
else  {
	...
	if(isset($in_edit_id)&&(int)$in_edit_id) {
		...
		$filter_session_name="filter_academic_year";
		$search=getacademic_yearControls('search');
	}
}


$__del_var="hdDeleteacademic_year";
$__editTable="academic_year";
$fn_Delete="";/*
$fn_Delete="del_academic_year";

function del_academic_year($del_id) {
	$db=getdb();
		
	$db->execute("delete from `academic_year` where id='{$del_id}'");
}*/
