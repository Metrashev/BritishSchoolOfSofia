...
if(CUserRights::checkResourceRights('academic_year')) {?><img src='<?=BE_IMG_DIR;?>z.gif' width='12' /><a onclick="setSelected(this);" class="a_level2" href='<?=BE_DIR;?>academic_year/edit.php?id=1&bkp=%2Fbe%2Facademic_year%2F' target='main'>Academic years</a><br /><? }
if(CUserRights::checkResourceRights('medical_form')) {?><img src='<?=BE_IMG_DIR;?>z.gif' width='12' /><a onclick="setSelected(this);" class="a_level2" href='<?=BE_DIR;?>medical_forms/' target='main'>Medical Forms</a><br /><br/><? }
if(CUserRights::checkResourceRights('admission')) {?><img src='<?=BE_IMG_DIR;?>z.gif' width='12' /><a onclick="setSelected(this);" class="a_level2" href='<?=BE_DIR;?>admission/' target='main'>Admission forms</a><br /><? }
if(CUserRights::checkResourceRights('admission_summer')) {?><img src='<?=BE_IMG_DIR;?>z.gif' width='12' /><a onclick="setSelected(this);" class="a_level2" href='<?=BE_DIR;?>admission_summer/' target='main'>Summer school forms</a><br /><br/><? }
if(CUserRights::checkResourceRights('contact_forms')) {?><img src='<?=BE_IMG_DIR;?>z.gif' width='12' /><a onclick="setSelected(this);" class="a_level2" href='<?=BE_DIR;?>contact_forms/' target='main'>Contact forms</a><br /><br/><? }
if(CUserRights::checkResourceRights('teachers')) {?><img src='<?=BE_IMG_DIR;?>z.gif' width='12' /><a onclick="setSelected(this);" class="a_level2" href='<?=BE_DIR;?>subject_names/' target='main'>Subject names</a><br /><? }
if(CUserRights::checkResourceRights('teachers')) {?><img src='<?=BE_IMG_DIR;?>z.gif' width='12' /><a onclick="setSelected(this);" class="a_level2" href='<?=BE_DIR;?>teachers/' target='main'>Teachers</a><br /><? }
if(CUserRights::checkResourceRights('subjects')) {?><img src='<?=BE_IMG_DIR;?>z.gif' width='12' /><a onclick="setSelected(this);" class="a_level2" href='<?=BE_DIR;?>subjects/' target='main'>Subjects for classes</a><br /><? }
if(CUserRights::checkResourceRights('classes')) {?><img src='<?=BE_IMG_DIR;?>z.gif' width='12' /><a onclick="setSelected(this);" class="a_level2" href='<?=BE_DIR;?>classes/' target='main'>Classes</a><br /><? }
if(CUserRights::checkResourceRights('events')) {?><img src='<?=BE_IMG_DIR;?>z.gif' width='12' /><a onclick="setSelected(this);" class="a_level2" href='<?=BE_DIR;?>event_calendar/' target='main'>Events and calendar</a><br /><? }
if(CUserRights::checkResourceRights('parents_guide')) {?><img src='<?=BE_IMG_DIR;?>z.gif' width='12' /><a onclick="setSelected(this);" class="a_level2" href='<?=BE_DIR;?>parents_guide/' target='main'>Parents guide</a><br /><? }
