...
<tbody>
<tr>
<td><label for="title_bg">Title bg</label></td>
<td><ITTI field_name='title_bg' style="width:95%"></ITTI></td>
</tr>
<tr>
<td><label for="title_en">Title en</label></td>
<td><ITTI field_name='title_en' style="width:95%"></ITTI></td>
</tr>
<tr>
<td colspan="2" align="left"><label for="body_bg">Text bg</label><br />
<ITTI field_name='body_bg' style="width:100%;height:400px;"></ITTI></td>
</tr>

<tr>
<td colspan="2" align="left"><label for="body_en">Text en</label><br />
<ITTI field_name='body_en' style="width:100%;height:400px;"></ITTI></td>
</tr>
