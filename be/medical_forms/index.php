...
if($__mvc) {
	...
	$filter_session_name="filter_medical_forms";
}
else  {
	...
	if(isset($in_edit_id)&&(int)$in_edit_id) {
		...
		$filter_session_name="filter_medical_forms";
		$search=getmedical_formsControls('search');
	}
}


$__del_var="hdDeletemedical_forms";
$__editTable="medical_forms";
$fn_Delete="";/*
$fn_Delete="del_medical_forms";

function del_medical_forms($del_id) {
	$db=getdb();
		
	$db->execute("delete from `medical_forms` where id='{$del_id}'");
}*/
