...
if($__mvc) {
	...
	$filter_session_name="filter_subjects";
}
else  {
	...
	if(isset($in_edit_id)&&(int)$in_edit_id) {
		...
		$filter_session_name="filter_subjects";
		$search=getsubjectsControls('search');
	}
}


$__del_var="hdDeletesubjects";
$__editTable="subjects";
$fn_Delete="";/*
$fn_Delete="del_subjects";

function del_subjects($del_id) {
	$db=getdb();
		
	$db->execute("delete from `subjects` where id='{$del_id}'");
}*/
