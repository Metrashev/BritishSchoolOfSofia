...
'controls'=>array(
	 ...
	 'value_en'=>
		array(
			'control'=>array('Label'=>"menu_en",'name'=>'in_data[value_en]','tagName'=>'Input','bound_field'=>'value_en','userFunc'=>'','FormatString'=>'',),
			'write_data'=>array('type'=>DATA_VARCHAR,'required'=>true),
		),
	 ...
	 'meta_keywords_en'=>
		array(
			'control'=>array('Label'=>"Keywords_en",'name'=>'in_data[meta_keywords_en]','tagName'=>'TextArea','bound_field'=>'meta_keywords_en','userFunc'=>'','FormatString'=>'',),
			'write_data'=>array('type'=>DATA_VARCHAR,),
		), 
     'meta_description'=>
        array(
	 ...
	 'meta_description_en'=>
		array(
			'control'=>array('Label'=>"Description_en",'name'=>'in_data[meta_description_en]','tagName'=>'TextArea','bound_field'=>'meta_description_en','userFunc'=>'','FormatString'=>'',),
			'write_data'=>array('type'=>DATA_VARCHAR,),
		),
	...
	'page_title_en'=>
		array(
			'control'=>array('Label'=>"Page title en",'name'=>'in_data[page_title_en]','tagName'=>'Input','bound_field'=>'page_title_en','userFunc'=>'','FormatString'=>'',),
			'write_data'=>array('type'=>DATA_VARCHAR,'required'=>false),
		),
     'visible'=>
        array(
