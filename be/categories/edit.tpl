...
<tr>
    <td align="right"><label for="value_en">Label en</label></td>
    <td><ITTI field_name="value_en" style='width:95%'></ITTI></td>
</tr>
...
<tr>
    <td align="right"><label for="meta_keywords_en">META Keywords en</label></td>
    <td><ITTI field_name="meta_keywords_en" style='width:95%;height:50px;' maxlength="255"></ITTI></td>
</tr>
...
<tr>
    <td align="right"><label for="meta_description_en">META Description en</label></td>
    <td><ITTI field_name="meta_description_en" style='width:95%;height:50px;'></ITTI></td>
</tr>
...
<tr>
    <td align="right"><label for="page_title_en">Page Title en</label></td>
    <td><ITTI field_name="page_title_en" style='width:95%'></ITTI>
    	<br /> Fill in if You want to be different from Label else leave it blank.
    </td>
</tr>
