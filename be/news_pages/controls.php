...
'lang'=>array(
	'control'=>array("Label"=>"Language","name"=>"in_data[lang]","isHTML"=>false,"tagName"=>"Select","bound_field"=>"lang","userFunc"=>"","FormatString"=>"", "autoload"=>array("type"=>"arrayname","value"=>array("DataSource"=>$GLOBALS['CONFIG']['SiteLanguages'],))),
	'write_data'=>array("type"=>DATA_VARCHAR,"required"=>true,),
),
